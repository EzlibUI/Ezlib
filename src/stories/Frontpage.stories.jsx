...
const mapInfo= { width: "100%", height: "400", location: "Hermannin rantatie", zoom: "16" }
  ...
  return (
    <div>
      ...
      image="https://nypost.com/wp-content/uploads/sites/2/2019/03/chunky-monkey-swns.jpg?quality=80&strip=all"
       ...
       title="Apina chillaa"
      />
      <Maps width={mapInfo.width} height={mapInfo.height} location={mapInfo.location} zoom={mapInfo.zoom}/>
    </div>
  )
})